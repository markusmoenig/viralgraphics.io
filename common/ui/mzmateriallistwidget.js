// ------------------------------------------------------- MZMaterialListWidget

MZMaterialListWidget=function( { dc, startRender, materialEdit, editCallback } = {} )
{
    VG.UI.Widget.call( this );

    VG.context.materialsUploadFolder = new VG.DB.Folder( "59e176d4dc694f034e4e532d" );
    VG.context.materialsFolder = new VG.DB.Folder( "59e176e6dc694f034e4e532e" );
...
MZMaterialListWidget.prototype=VG.UI.Widget();

MZMaterialListWidget.prototype.addAdminSpecific=function()
{
    this.adminMode=true;
...
MZMaterialListWidget.prototype.compileMaterial=function( item, itemNeedsUpdate, verify )
{
...
MZMaterialListWidget.prototype.createMaterial=function()
{
...
MZMaterialListWidget.prototype.createMaterialForItem=function( item )
{
...
MZMaterialListWidget.prototype.createUploadMaterialForItem=function( item )
{
    if ( !item.offset ) item.offset = { x : 0, y : 0 };
...
MZMaterialListWidget.prototype.compressMaterial=function()
{
    let arr=[];
...
MZMaterialListWidget.prototype.paintWidget=function( canvas )
{
