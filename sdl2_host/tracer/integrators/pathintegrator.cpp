...
namespace embree
{
  PathIntegrator::PathIntegrator(const Parms& parms)
  ...
  void PathIntegrator::requestSamples(Ref<SamplerFactory>& samplerFactory, const Ref<BackendScene>& scene)
  {
    ...
    Color PathIntegrator::Li(LightPath& lightPath, const Ref<BackendScene>& scene, IntegratorState& state)
    {
  ...
  Color PathIntegrator::Li(Ray& ray, const Ref<BackendScene>& scene, IntegratorState& state) {
